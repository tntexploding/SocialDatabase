...
运行，访问日志关闭。轮换时可短期设置一个旧令牌。接口与环境变量见
...
地址；完整部署和升级流程见 [docs/docker.md](docs/docker.md)。公网云服务器可用
...
当前范围和后续真实部署计划见 [docs/roadmap.md](docs/roadmap.md)。
